...
#from twisted.python import deprecate		removed (Amol)
#from twisted.python.versions import Version	removed (Amol)
...
'''deprecate.deprecatedModuleAttribute(
    ...
    __name__,
    "IStreamClientEndpointStringParser")'''	#removed (Amol)
